...
#SBATCH --output=./run/logs/kb20_depth5000_imputejob_prep_%j.log  # 标准输出日志
#SBATCH --error=./run/logs/kb20_depth5000_imputejob_prep_%j.log   # 标准错误日志
...
# 预处理数据目录
PREPROCESSED_DIR="data/h5ad_final_20000/preprocessed"
