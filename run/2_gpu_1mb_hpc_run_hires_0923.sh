...
# ==============================================================================
#SBATCH --job-name=1mb_hires_impute       # 作业名称
#SBATCH --output=./run/logs/1mb_imputed_job_%j.log          # 标准输出日志
#SBATCH --error=./run/logs/1mb_imputed_job_%j.log           # 标准错误日志 (与输出合并，强烈推荐)
