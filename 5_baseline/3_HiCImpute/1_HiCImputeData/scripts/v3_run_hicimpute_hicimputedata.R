...
main <- function() {
  ...
  niter <- as.integer(argval(args, "--niter", "50000"))
  burnin <- as.integer(argval(args, "--burnin", "5000"))
  ...
  npz_path <- file.path(output_root, "npz_lower_tri", paste0(dataset, "_hicimpute_Impute_All_lower_tri.npz"))
