...
from schicdiff.modules.diffusion_model import Decoder, Embedder, Encoder
from schicdiff.evaluate import (
    denoising_eval
)
from schicdiff.modules.ema import LitEma
from schicdiff.modules.layers.attention import BasicTransformerBlock
from schicdiff.modules.layers.basic import FeedForward
from schicdiff.modules.layers.scmodel import EmbeddingDict
from schicdiff.utils.diffusion import MaskedEncoderConditioner, timestep_embedding
from schicdiff.utils.diffusion import make_beta_schedule
from schicdiff.utils.misc import as_1d_vec, exists, count_params, instantiate_from_config
from schicdiff.utils.misc import default
from schicdiff.utils.modules import create_activation, create_norm
from schicdiff.utils.modules import extract_into_tensor, init_weights, mean_flat, noise_like
from schicdiff.utils.data import cal_depth_factor, scHiC_normalize, inverse_scHiC_normalize, save_result
...
class ScDiff(pl.LightningModule):
    ...
    def p_losses(self, x_start, t, noise=None, conditions=None, input_gene_list=None,
        ...
        if not self.balance_loss:
            ...
            α=0.9
            loss = α * loss_nonzero + (1-α) * loss_zero
